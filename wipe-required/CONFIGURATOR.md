# Supervise without MDM — this erases the iPhone
...
This is **not** MDM. It does **not** need an Apple Developer certificate. It is Route B in the root README.

After supervision, restrictions that a Safari profile cannot apply will start working. `OpenHat-Supervised.mobileconfig` in this folder also hides Instagram, Facebook, Messenger, Snapchat, TikTok, X, Pinterest, Reddit, and LinkedIn.
...
5. **Manual Configuration**. Enable **Supervise devices**. Leave **Automatically enroll in MDM** **off** (turn it on only for Route D).
