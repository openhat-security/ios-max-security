...
echo "  5. python3 enqueue_profile.py ../profiles/OpenHat-Level-1-Mullvad.mobileconfig --udid UDID"
echo "  Erase then enroll (ERASES the iPhone): Configurator Prepare+Supervise, then"
echo "  python3 enqueue_profile.py ../wipe-required/OpenHat-Level-4-Mullvad.mobileconfig --udid UDID"
